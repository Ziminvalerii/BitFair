...
class InstructionNode: SKSpriteNode, FrameNodeProtocol {
    ...
    var instructionNode: SKLabelNode = {
        let text =  NSAttributedString(string: "Buy for \(InstructionModel.joistickTopic.rawValue)", attributes: [.font : UIFont(name: "PixelCyr-Normal", size: 17)!, .foregroundColor: UIColor.white])
